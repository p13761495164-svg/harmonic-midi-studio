...
test("ships the focused MIDI track player", async () => {
  ...
  assert.match(page, /APP_VERSION = "2026\.08\.02\.1"/);
  ...
  assert.match(page, /PianoRollEditorView/);
  assert.match(page, /openPianoRoll/);
  assert.match(page, /onDoubleClick=/);
  assert.match(page, /Key = \{activeEditorKey\.key\}/);
  assert.match(page, /degreeForMidi/);
  assert.match(page, /pianoRollNoteId/);
  assert.match(page, /deletePianoRollNotes/);
  assert.match(page, /transposePianoRollNotes/);
  assert.match(page, /beginBoxSelection/);
  assert.match(page, /beginNoteDrag/);
  assert.match(page, /startRegionPlayback/);
  assert.match(page, /pianoRollSessionRef/);
  assert.match(page, /savePianoRoll/);
  assert.match(page, /cancelPianoRoll/);
  assert.match(page, /保存返回/);
  assert.match(page, /已取消 Piano Roll 修改/);
  assert.match(page, /Esc 取消/);
  ...
  assert.match(css, /\.piano-roll-backdrop/);
  assert.match(css, /\.piano-roll-editor/);
  assert.match(css, /\.piano-roll-grid/);
  assert.match(css, /\.piano-roll-note\.selected/);
  assert.match(css, /\.piano-roll-playhead/);
  assert.match(css, /\.piano-roll-selection-box/);
